...
public class LocalRunTest {
    ...
    public void calculateLargestDistance() {
        ...
        for (int i = 1; i < arrayList.size(); ++i) {
            System.out.println("From:\t" + String.format("%04d", arrayList.get(i - 1)) + "\tTo:\t" + String.format("%04d", arrayList.get(i)) + "\tDistance:\t" + (arrayList.get(i) - arrayList.get(i - 1) - 1));
            if (arrayList.get(i) - arrayList.get(i - 1) - 1 > maxDistance) {
                maxDistance = arrayList.get(i) - arrayList.get(i - 1) - 1;
